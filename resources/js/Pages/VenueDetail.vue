<template>
  <Head :title="venue.name">
    <meta name="description" :content="`Eventos en ${venue.name}. ${venue.eventCount} ${venue.eventCount === 1 ? 'evento' : 'eventos'} en ${venue.city}, ${venue.state}.`" />
    <meta property="og:title" :content="venue.name" />
    <meta property="og:description" :content="`Eventos en ${venue.name}.`" />
  ...
  <div class="page-layout">
    ...
    <main id="main-content">
      <section class="venue-hero">
        <div class="container">
          <div class="venue-hero-frame">
            <picture class="venue-hero-picture">
            ...
            <div class="venue-hero-content">
              ...
              <p class="venue-count">{{ venue.eventCount }} {{ venue.eventCount === 1 ? 'evento' : 'eventos' }} próximos</p>
            </div>
          </div>
        </div>
      </section>
